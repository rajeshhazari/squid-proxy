...
var aclScriptUpdateRouter = express.Router();
var squidInstallProps = require('../resources/config/index.d').squidInstallProps
var shell = require('shelljs');


aclScriptUpdateRouter.get('/db/all', function(req, res) {
...
aclScriptUpdateRouter.get('/db/file/update', function(req, res) {
    console.dir(req.xhr)
    req.accepts('json, text/plain');
    // Call your python script here.
    // I prefer using spawn from the child process module instead of the Python shell
    var fname = decodeURI(req.query.filename);
    ...
    res.status(200).json({"data": updateScriptcmd, "params" : shellCmd});
...
//    })
//}
module.exports = aclScriptUpdateRouter;